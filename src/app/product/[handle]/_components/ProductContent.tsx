              ...
              <Accordion type="single" collapsible className="w-full">
                {productDetailMeta?.value && (
                  <AccordionItem value="product-detail">
                    <AccordionTrigger className="font-mono text-sm font-medium">Product Details</AccordionTrigger>
                ...
                {dimsMeta?.value && (
                  <AccordionItem value="dimensions">
                    <AccordionTrigger className="font-mono text-sm font-medium">Dimensions</AccordionTrigger>
                    <AccordionContent className="text-sm leading-relaxed text-muted-foreground">
                ...
                {productCareMeta?.value && (
                  <AccordionItem value="materials-care">
                    <AccordionTrigger className="font-mono text-sm font-medium">Materials & Care</AccordionTrigger>
                    <AccordionContent className="text-sm leading-relaxed text-muted-foreground">
                ...
                <AccordionItem value="sustainability">
                  <AccordionTrigger className="font-mono text-sm font-medium">Sustainability & Certifications</AccordionTrigger>
                  <AccordionContent className="text-sm leading-relaxed text-muted-foreground">
                    <p>
                ...
                <AccordionItem value="faqs">
                  <AccordionTrigger className="font-mono text-sm font-medium">FAQs</AccordionTrigger>
                  <AccordionContent className="space-y-4 text-sm leading-relaxed text-muted-foreground">
                    ...
                    <div>
                      ...
                      <p className="mt-1">
                        Most in-stock items are delivered within 5 to 10 business days, with a WhatsApp confirmation
                ...
                {pairsWellWith.length > 0 && (
                  <AccordionItem value="pairs-well-with">
                    <AccordionTrigger className="font-mono text-sm font-medium">Pairs well with</AccordionTrigger>
                    <AccordionContent>
